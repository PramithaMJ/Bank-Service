...
@Tag(
        name = "CRUD REST APIs for Cards in PMJ",
        description = "CRUD REST APIs in PMJ to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside PMJ"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
